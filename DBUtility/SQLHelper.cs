...
namespace DBUtility
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static readonly string Connection_PlatForm = ConfigurationManager.ConnectionStrings["SQL_PlatForm"].ToString();
        ...
        //public static readonly string ConnectionStringLocalTransaction =Encrypt.MyDESCryptoDe( ConfigurationManager.ConnectionStrings["SQLMainDBConnString"].ConnectionString);
        //public static readonly string ConnectionStringProfile = Encrypt.MyDESCryptoDe(ConfigurationManager.ConnectionStrings["SQLProfileConnString"].ConnectionString);
        //public static readonly string ConnectionStringMembership = Encrypt.MyDESCryptoDe(ConfigurationManager.ConnectionStrings["SQLMembershipConnString"].ConnectionString);
        ...
        /// <param name="comList">处理的参数</param>
        /// <returns>0失败，1，成功</returns>
        public static int ExecuteNonQuery(string connectionString, List<CommandInfo> comList)
        {
            SqlCommand cmd = new SqlCommand();
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    {
                        PrepareCommand(cmd, conn, trans, CommandType.Text, info.Sql_str, info.Parames);
